...
class CartPage:
    def add_products_to_cart(self):
        ...
        button_add_to_cart = browser.all(
        ...
        for button_cart in button_add_to_cart:
            ...
            continue_button = browser.element(
                ".btn.btn_primary.btn_block.js-modal-close"
            )
    ...
    def assert_count_product_to_cart(self):
        cart_count = browser.element(
            "[id='header_basket_count js-header-cart-click']"
    ...
    def cart_button_click(self):
        browser.element("[id='header_basket_count js-header-cart-click']").click()

        return self

    def checkbox_select_all_click(self):
        browser.element('[for="cart-select-all"]').click()

        return self

    def cart_delete_all_button_click(self):
        browser.element('[id="cart-delete-all"]').click()
